...
<?php if ($comments) : ?>
	<h3 id="comments"><?php comments_number('There Are No Responses Yet.', 'There Is 1 Response So Far.', 'There Are % Responses So Far.' );?> <a href="#respond" title="<?php _e("Leave a comment"); ?>">&raquo;</a></h3>
